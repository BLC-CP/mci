  ...
  <div class="row mt-3">
   <div class="col-lg-12">
      <div class="card card-primary">
         ...
         <!-- /.card-header -->
         <!-- form start -->
         <form role="form" action="{{ route('suku.store') }}" method="POST">
            @csrf
           <div class="card-body">
             <div class="form-group">
               <label for="suku">Naran Suku</label>
               <input type="text" class="form-control form-control-sm @error('nrn_suku') is-invalid @enderror " name="nrn_suku" id="suku" value="{{ old('nrn_suku') }}" placeholder="Naran Suku">
               @error('nrn_suku')

         ...
         <form role="form" action="{{ route('aldeia.store') }}" method="POST">
           ...
           <div class="card-body">
             <div class="form-group">
               ...
               <input type="text" class="form-control form-control-sm @error('nrn_aldeia') is-invalid @enderror " value="{{ old('nrn_aldeia') }}" name="nrn_aldeia" id="aldeia" placeholder="Naran Aldeia">
               @error('nrn_aldeia')
